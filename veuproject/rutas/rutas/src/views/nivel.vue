...
<div class="buton">
 ...
 <div>
    <h2>Login</h2>
    <input v-model="usuario" type="text" placeholder="Ingresa tu usuario" />
...
<script setup>
  const usuario = ref(""), mensaje = ref(""); const guardarUsuario = () => (localStorage.setItem("usuario", usuario.value), mensaje.value = "Usuario guardado");
